...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_JOGRECORD = "_id";
    ...
    public static final String CREATE_TABLE_SQL = "create table " + TABLE_JOGRECORD + " " +
            "(" + COLUMN_ID + " integer primary key autoincrement," + COLUMN_DATE + " text not null," +
